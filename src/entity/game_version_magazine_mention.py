...
class GameVersionMagazineMention(AbstractEntity):
    """ This class represent when a versioon of a game is mentioned the issue of a magazine. """
    ...
    table_name = 'game_version_magazine_mentions'
    ...
    def get_game_version_id(self) -> int:
