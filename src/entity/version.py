...
class Version:
    ...
    expected_fields = {
        'platformId': {'field': 'platform_id', 'method': '_platform_id', 'required': True},
        'gameId': {'field': 'game_id', 'method': '_game_id', 'required': True},
        'releaseYear': {'field': 'release_year', 'method': '_release_year', 'required': True},
        'todoSoloSometimes': {'field': 'todo_solo_sometimes', 'method': '_todo_solo_sometimes', 'required': True},
        'todoMultiplayerSometimes': {'field': 'todo_multiplayer_sometimes', 'method': '_todo_multiplayer_sometimes', 'required': True},
        'singleplayerRecurring': {'field': 'singleplayer_recurring', 'method': '_singleplayer_recurring', 'required': True},
        'multiplayerRecurring': {'field': 'multiplayer_recurring', 'method': '_multiplayer_recurring', 'required': True},
        'toDo': {'field': 'to_do', 'method': '_to_do', 'required': True},
        'toBuy': {'field': 'to_buy', 'method': '_to_buy', 'required': True},
        'toWatchBackground': {'field': 'to_watch_background', 'method': '_to_watch_background', 'required': True},
        'toWatchSerious': {'field': 'to_watch_serious', 'method': '_to_watch_serious', 'required': True},
        'toRewatch': {'field': 'to_rewatch', 'method': '_to_rewatch', 'required': True},
        'topGame': {'field': 'top_game', 'method': '_top_game', 'required': True},
        'hallOfFame': {'field': 'hall_of_fame', 'method': '_hall_of_fame', 'required': True},
        'hallOfFameYear': {'field': 'hall_of_fame_year', 'method': '_hall_of_fame_year', 'required': False, 'default': 0},
        'hallOfFamePosition': {'field': 'hall_of_fame_position', 'method': '_hall_of_fame_position', 'required': False, 'default': 0},
        'playedItOften': {'field': 'played_it_often', 'method': '_played_it_often', 'required': True},
        'ongoing': {'field': 'ongoing', 'method': '_ongoing', 'required': True},
        'comments': {'field': 'comments', 'method': '_comments', 'required': False, 'default': ''},
        'todoWithHelp': {'field': 'todo_with_help', 'method': '_todo_with_help', 'required': True},
        'bestGameForever': {'field': 'bgf', 'method': '_best_game_forever', 'required': True},
        'toWatchPosition': {'field': 'to_watch_position', 'method': '_to_watch_position', 'required': False, 'default': 0},
        'toDoPosition': {'field': 'to_do_position', 'method': '_to_do_position', 'required': False, 'default': 0},
    }
